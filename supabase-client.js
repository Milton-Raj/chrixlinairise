...
(function (global) {
  ...
  function _rowToPlan(r) {
    return { id: r.id, name: r.name, price: r.price, priceLabel: r.price_label, period: r.period, badge: r.badge, badgeColor: r.badge_color, badgeBg: r.badge_bg||(r.badge_color ? r.badge_color+'22' : ''), description: r.description, cta: r.cta, ctaLink: r.cta_link, highlighted: r.is_highlighted, features: r.features||[], sortOrder: r.sort_order, isActive: r.is_active, billingCycle: r.billing_cycle||'monthly', visible: r.visible !== false };
  }
